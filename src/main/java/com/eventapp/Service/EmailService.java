...
public class EmailService {
	...
	public void sendRegistrationSuccessEmail(Student student, Event event) {
		...
		try {
			...
			String body = "<html><body>" + "<p>Dear <b>" + student.getStudentName() + "</b>,</p>"
					...
					+ event.getEventDate() + "</b> has been <b>successfully submitted</b>.</p>"

					+ "<p>Your registration is currently in <b>PENDING</b> state. " 
					+ "Please complete the payment to confirm your seat.</p>"

					+ "<p><b>Event Details:</b><br>" + "📍 Venue: " + event.getVenue() + "<br>"
					+ "🗺️ Location: <a href='" + event.getLocationLink()
					+ "' target='_blank'>View on Google Maps</a><br>" + "</p>"

					+ "<p>Once payment is completed, your registration will be automatically approved.</p>"

					+ "<p>If you have any questions, feel free to contact us at " + "<b>support@eventapp.com</b>.</p>"

					+ "<p>We look forward to your participation!</p>" + "<p>Regards,<br>"
	...
	public void sendApprovalEmail(Student student, Event event) {
		...
		String body = "Dear " + student.getStudentName() + ",\n\n"
				...
				+ "<p><b>Event Details:</b><br>" + "📍 Venue: " + event.getVenue() + "<br>" + "🗺️ Location: <a href='"
				+ event.getLocationLink() + "' target='_blank'>View on Google Maps</a><br>" + "</p>"
	...
	public void sendPaymentSuccessMail(String toEmail, String studentName, String eventName, String eventDate,
			Double amount, byte[] pdf, String venue, String locationLink) {
		...
		try {
			...
			String body = "<html><body>" 
			        ...
			        + "<p>Your payment for the event <b>\"" + eventName + "\"</b> "
			        + "scheduled on <b>" + eventDate + "</b> has been successfully <b>completed</b>.</p>"

			        + "<p><b>Payment Details:</b><br>"
			        + "Amount Paid: ₹" + amount + "<br>"
			        + "Status: SUCCESS</p>"

			        + "<p>Your registration has been <b>confirmed</b> and your seat is now secured.</p>"

			        + "<p><b>Event Details:</b><br>"
			        + "📍 Venue: " + venue + "<br>"
			        + "🗺️ Location: <a href='" + locationLink + "' target='_blank'>View on Google Maps</a><br>"
			        + "</p>"

			        + "<p>Please find your <b>payment receipt attached</b> with this email.</p>"

			        + "<p>If you have any questions, feel free to contact us at "
			        + "<b>support@eventapp.com</b>.</p>"

			        + "<p>We look forward to your participation. Best of luck!</p>"

			        + "<p>Regards,<br>"
			        + "<b>Event Management Team</b><br>"
			        + "support@eventapp.com<br>"
			        + "+91 9876543210</p>"
